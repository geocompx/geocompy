...
#| echo: false
#| output: false
map_to_png(nz.explore(), 'fig-explore')
```
...
#| echo: false
#| output: false
map_to_png(nz.explore(color='green', style_kwds={'color':'black', 'opacity':0.3}), 'fig-explore-styling-polygons')
```
...
#| echo: false
#| output: false
map_to_png(nz_height.explore(marker_type='marker'), 'fig-explore-styling-points2')
```
...
#| output: false
m = nz.explore()
map_to_png(nz_height.explore(m=m, color='red'), 'fig-explore-layers')
```
...
nz_height.explore(m=m, color='red', name='Points (elevation)')
folium.LayerControl(collapsed=False).add_to(m)
map_to_png(m, 'fig-explore-layers-controls')
```
...
#| echo: false
#| output: false
map_to_png(nz.explore(column='Median_income', legend=True, cmap='Reds'), 'fig-explore-symbology')
```
...
#| echo: false
#| output: false
map_to_png(nz.explore(column='Median_income', legend=True, cmap='Reds', style_kwds={'color':'black', 'weight': 0.5}), 'fig-explore-symbology2')
```
...
#| echo: false
#| output: false
map_to_png(nz.explore(tiles='CartoDB positron'), 'fig-explore-basemaps')
```
