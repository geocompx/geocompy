...
For example, let us read (@sec-using-rasterio) the `elev.tif` raster values into an array named `elev`: 
...
@fig-raster-local-operations demonstrates these two examples, and two other ones.
