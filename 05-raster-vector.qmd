...
Like all GDAL programs (also see `gdaldem` example in @sec-focal-operations), `gdal_contour` works with files. Here: 
...
Here is a plot of the contour layer `dem_contour.gpkg` (@fig-raster-contours2):
