...
<!-- md: note to self that if we switch to a more efficient raster-to-points method (following Anita's suggestion), then this code block needs to be changed as well -->
...
<!-- md: note to self, this should be replaced with more efficient code following Anita's suggestion -->
...
<!-- md: the following example should be relaced to more efficient code following Anita's suggestion, afterwards will rephrase the text too -->
