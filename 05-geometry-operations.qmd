...
To match resolutions, or to modify the resolution for other reasons (such as conserving storage space), one can either decrease (aggregate) or increase (disaggregate) the resolution of one raster. 
...
Note the shape of the raster, at has 117 rows and 117 columns:
