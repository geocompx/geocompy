...
Each new pixel is now obtained, or "resampled", from ~5×5=25 "old" raster values. 
...
The target and destination CRS are straightforward to specify, depending on out choice. The source transform is also available, e.g., from the source file connection. 
