...
The subsequent code chunks demonstrate how this works for the other combinations of the 'Venn' diagram representing x and y, inspired by Figure 5.1 of the book R for Data Science (Grolemund and Wickham 2016). In addition to `.intersection`, we hereby use the `.difference`, `.union`, and `.symmetric_difference` operators:
