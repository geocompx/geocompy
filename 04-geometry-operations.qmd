...
However, we encourage the reader to reproduce the results to deepen your understanding for handling geographic vector objects in Python as it raises an important question: which implementation to use?
