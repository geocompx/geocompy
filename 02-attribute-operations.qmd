...
<!-- md: agree, this can be confusing because it's not used in practice -->
...
Then, we can access any subset of cell values using **numpy** methods, e.g., `elev[1, 2]` returns the value at row 2, column 3.
