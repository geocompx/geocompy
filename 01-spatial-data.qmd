...
#| echo: false
#| output: false
map_to_png(gdf.explore(), 'fig-gdf-explore')
```
...
#| echo: false
#| output: false
map_to_png(gdf[gdf['name_long'] == 'Egypt'].explore(), 'fig-gdf-explore2')
```
...
#| output: false
gdf = gdf.set_geometry('bbox')
map_to_png(gdf.explore(), 'fig-switch-to-centroids')
```
...
#| output: false
gdf = gdf.set_geometry('polygon')
map_to_png(gdf.explore(), 'fig-switch-to-polygons')
```
...
#| echo: false
#| output: false
map_to_png(towns_layer.explore(color='red', marker_kwds={'radius': 10}), 'fig-layer-from-scratch-explore')
```
