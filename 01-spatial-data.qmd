...
`shapely` geometries act as atomic units of vector data, as spatial operations on a geometry return a single new geometry.<!--jn: I do not understand the previous sentence...-->
