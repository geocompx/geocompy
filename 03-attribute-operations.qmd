...
```{python}
world_agg2 = world[['continent', 'pop', 'geometry']].dissolve(by='continent', aggfunc='sum')
world_agg2
```
...
```{python}
world_agg3a = world[['continent', 'area_km2', 'geometry']].dissolve(by='continent', aggfunc='sum')
world_agg3b = world[['continent', 'name_long', 'geometry']].dissolve(by='continent', aggfunc=lambda x: x.nunique()).rename(columns={"name_long": "n"})
