...
We are developing it in the open and publishing an up-to-date online version at <https://py.geocompx.org> (with a backup at <https://geocompx.github.io/geocompy>).
...
The instructions below are for [micromamba](https://mamba.readthedocs.io/en/latest/installation/micromamba-installation.html) but should work for any package manager.
