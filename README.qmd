...
2. [VS Code](https://code.visualstudio.com/), another IDE, or [Jupyter Notebook](https://github.com/geocompx/geocompy/tree/main/ipynb) for running and exploring the Python code interactively
